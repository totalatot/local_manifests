...
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
cd hardware/qcom/display && git fetch https://github.com/totalatot/android_hardware_qcom_display lineage-18.1 && git cherry-pick 1f5881f873b2448b0f8932018322ff06f067720f^..d631b7b2e6ae03ac65d5cc88148dd87e404fca34
...
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
cd hardware/qcom-caf/wlan && git fetch https://github.com/totalatot/android_hardware_qcom_wlan lineage-20.0-caf && git cherry-pick 2a0ea9aefc9a73d59e45741d329f9663229ff085
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
...
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
cd vendor/lineage && git fetch https://github.com/totalatot/android_vendor_lineage lineage-20.0 && git cherry-pick 4c0e079d8d667c4e6b07b0527bee7c2d4b4d273e^..70f7cfc939944181ced18701dd62a414fd79bcd8
