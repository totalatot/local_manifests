...
cd device/moto/shamu && git fetch https://github.com/totalatot/lineage_device_moto_shamu lineage-20.0:total && git checkout total
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
cd kernel/moto/shamu && git fetch https://github.com/totalatot/lineage_kernel_moto_shamu lineage-20.0:total && git checkout total
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
# hardware
...
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
# lineage
cd art && git fetch https://github.com/LineageOS-UL/android_art lineage-20.0 && git cherry-pick 784077b3e7b3c94f9a66b9f624a34fdb441ddefc
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
...
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
cd packages/modules/Connectivity && git fetch https://github.com/LineageOS-UL/android_packages_modules_Connectivity lineage-20.0 && git cherry-pick ff018f7a656e7958a42db6d6893f5df35bd985ed
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
...
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
cd external/perfetto && git fetch https://github.com/LineageOS-UL/android_external_perfetto lineage-20.0 && git cherry-pick 0037c7c95292eeb9ee6848b6e4a0e4494486d56b
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
cd frameworks/libs/net && git fetch https://github.com/LineageOS-UL/android_frameworks_libs_net lineage-20.0 && git cherry-pick 0e14c27808b260024fd0b192d01b71c404550e75
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
...
glo -10 && pwd && echo "====================================================== done ======================================================" && cd -
# totalize
cd frameworks/base && git fetch https://github.com/totalatot/android_frameworks_base lineage-20.0 && git cherry-pick 848f3c2bf4c7578b42f82d43b04d24ebdcf1c4f5^..104f5ee9c7df3c7ae4d67e94ef642a061434ed58
glo -5 && pwd && echo "====================================================== done ======================================================" && cd -
